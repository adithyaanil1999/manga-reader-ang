    ...
    if (reliable === false) {
      return new Promise((resolve, reject) => {
        ...
        var raw = JSON.stringify({
          url:
            "https://fanfox.net/manga/a_story_about_treating_a_female_knight_who_has_never_been_treated_as_a_woman_as_a_woman/v01/c099/1.html",
          reliable: false,
        });
        ...
        fetch(
          "https://mangapark.net/manga/jujutsu-kaisen/i2622370/c133/1",
          requestOptions
        )
          .then((response) => {
            let html = response;
